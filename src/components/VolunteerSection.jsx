...
import { MessageSquare, Phone, UserCheck, Heart, Sparkles, ExternalLink } from 'lucide-react';

export default function VolunteerSection() {
  const contacts = [
    {
      name: 'Afzal Ansari',
      role: 'Student Lead & CEP Coordinator',
    ...
    },
    {
      ...
      phoneRaw: '+91 93258 89516',
      waUrl: 'https://wa.me/91932589516',
      avatarBg: 'bg-[#D96B43]',
      initials: 'SB',
    },
  ];
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="text-center max-w-3xl mx-auto mb-16">
          ...
          <p className="text-base sm:text-lg text-[#4F5E56] leading-relaxed">
            We are currently developing Food Fed as a CEP initiative. Want to help us turn the idea into community action? Reach out to our student coordinators!
          </p>
        </div>
            ...
            >
              <div>
                <div className="flex items-center gap-4 mb-6">
                  <div className={`w-14 h-14 rounded-2xl ${person.avatarBg} text-white font-display font-extrabold text-xl flex items-center justify-center shadow-md group-hover:scale-105 transition-transform`}>
                    {person.initials}
                  </div>
                  <div>
                ...
                <div className="bg-[#FAF7F2] rounded-2xl p-4 border border-[#E8DFD1] mb-6 flex items-center justify-between">
                  ...
                  <a
                    href={`tel:${person.phoneRaw.replace(/\s+/g, '')}`}
        ...
        <div className="mt-12 text-center max-w-xl mx-auto bg-[#E2EBE4] rounded-2xl p-4 border border-[#84A98C]/30 text-xs text-[#1B382B]">
          <div className="flex items-center justify-center gap-2 font-bold mb-1">
            ...
            <span>Proposed CEP Initiative Notice</span>
          </div>
          <p className="text-[#4F5E56]">
            Food Fed is an active student proposal under the Community Engagement Program (CEP). We welcome student volunteers, mentors, and local food establishment partners.
          </p>
        </div>
